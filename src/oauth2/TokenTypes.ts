...
class TokenTypesMiddleware {
    ...
    public static checkTokenTypeHint(request, response, next: Function) {
        try {
            assert.notEqual(TokenTypes.toArray().indexOf(request.body.token_type_hint), -1);
    ...
    public static isRefreshToken(request, response, next: Function) {
        try {
    ...
    public static isAccessToken(request, response, next: Function) {
        try {
     ...
     * */
    public static isUnknown(request, response, next: Function) {
        try {
